# This IRAF script scales, then subtracts, [OIII] off-band data from
# corresponding on-band Mosaic II data.
...
# Define scaling factors that are the ratio of the median pixel value in the
# off-band to on-band data.
real scale_array[3]
