...
| File                    | Notes              |
| :---------------------- | :----------------- |
| `src/fits-segmenter.sh` | Bash shell script. |
...
Command-line usage: `./fits-segmenter.sh [-h] [-m <mode argument>] [target FITS files list]`
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Target FITS files should be in the same directory as `fits-segmenter.sh`.\
...
```sh
./fits-segmenter.sh -m single F1759-2841_diff F1759-2915_diff F1803-2807_diff
```

Example, dual mode:

```sh
./fits-segmenter.sh -m dual F1759-2841_O3 F1759-2841_O3_off F1759-2915_O3 F1759-2915_O3_off F1803-2807_O3 F1803-2807_O3_off
```
